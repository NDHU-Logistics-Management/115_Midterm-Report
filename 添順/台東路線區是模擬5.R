...
route_type$data1$cross <- c(309, 8111, 8113, 8181)
route_type$data1$south <- c(8132, 8135, 8136, 8137, 8138, 8150, 8151, 8152, 8156, 8157, 8158)

route_type$data1$zhiben <- c(8113, 8115, 8128, 8129, 8130, 8131, 8153, 8180)
...
volumebyyearfig <- function(df) {
  ...
  par(family = "kai", mar = c(5, 6, 4, 12)) # 字體與圖寬
  ...
  title(
    main = paste0(
      min(years) - 1911, "年", "至", max(years) - 1911,
      "年臺東縣公路客運年總運量折線圖"
    ),
    cex.main = 2,
    adj = 0
...
ticket_hist <- function(tab, yr) {
  ...
  title(main = paste0(yr, "年臺東縣公路客運搭車持卡身分長條圖"), cex.main = 2, adj = 0)
...
ticket_hist <- function(tab, yr) {
  ...
  title(main = paste0(yr, "年臺東縣公路客運搭車定期票長條圖"), cex.main = 2, adj = 0)
