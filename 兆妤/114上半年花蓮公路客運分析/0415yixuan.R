...
volumebymonthfig <- function(df) {
    ...
    title(
        main = "114年1月至114年6月花蓮縣公路客運總運量折線圖",
        cex.main = 2,
        adj = 0
    )
...
cardbyfig <- function(df) {
    ...
    title(main = "114年1月至114年6月花蓮縣公路客運持卡身分長條圖", cex.main = 2, adj = 0)
...
path <- "img/barplot/"
check_path(path)
img_filename <- "114年1月至114年6月花蓮縣公路客運持卡身分長條圖"
